...
class HomePage extends React.Component {
  ...
  onPressConnect() {
    console.log(`Trying to connect to user with code ${this.state.code}`);
    this.props.navigation.navigate("routeQueuePage", { code: this.state.code });
  }
    ...
    return (
      <ScrollView contentInsetAdjustmentBehavior="automatic" style={styles.scrollView}>
        ...
        <View style={styles.submitCodeButtonWrapper}>
          <TouchableOpacity onPress={() => this.onPressConnect()} style={styles.submitCodeButton}>
